...
class Consumer(object):
    ...
    def consume(self, no_ack=None):
        ...
        if self.queues:
            ...
            for queue in H:
                print 'consuming from %s' % queue
                self._basic_consume(queue, no_ack=no_ack, nowait=True)

            print 'now consumering from %s' % T
    ...
    def receive(self, body, message):
        ...
        print 'calling callbacks - %s' % callbacks
        if not callbacks:
    ...
    def _basic_consume(self, queue, consumer_tag=None,
        ...
        if tag is None:
            ...
            print 'calling queue.consume'
            print 'queue is a %s' % type(queue)
