...
class Connection(AbstractChannel):
    ...
    def _wait_method(self, channel_id, allowed_methods):
        ...
        print 'called _wait_method for channel %s, there was %s in the queue' % (channel_id, (method_queue and len(method_queue) or 0))
        ...
        for queued_method in method_queue:
            ...
            if (allowed_methods is None) \
                    ...
                    or (method_sig == (20, 40)):
                print 'dealing with one of our queued methods %s' % str(queued_method)
        ...
        while 1:
            ...
            #
            print 'Queueing up %s for later' % str(method_sig)
        ...
        for channel_id, channel in items(channels):
            ...
            for queued_method in method_queue:
                ...
                if (allowed_methods is None or
                        method_sig in allowed_methods or
                        method_sig == (20, 40)):
                    print 'dealing with a queued method %s in _wait_multiple' % str(method_sig)
                    method_queue.remove(queued_method)
